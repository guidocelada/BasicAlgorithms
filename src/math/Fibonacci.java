...
public class Fibonacci {
    ...
    public static long calculateFibonacci(long n) { // calculate until result
						    // reach n
	...
	fibonacci.put((long) 0, (long) 0);
	fibonacci.put((long) 1, (long) 1);

	isFibonacci = new HashSet<Long>();
	isFibonacci.add((long) 0);
	isFibonacci.add((long) 1);
